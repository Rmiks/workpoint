		...
		foreach( $menu as $key => $menuItem )
		{
			if( $menuItem['module_name'] == 'leafBaseModule' || $menuItem['module_name'] == 'emailsModule' )
			{
                ...
                if(!empty($baseModuleMenuItems))
                {
                    ...
                    {
                    	foreach ($group as $subItemKey => $subItem) {
                    		if (_admin_module_access($subItemKey)) {
                    			$someModuleIsEnabled = true;
                    		}
                    	}

                    	if (isset($someModuleIsEnabled) && $someModuleIsEnabled) {
                    		$item = array
	                        (
