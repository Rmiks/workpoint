...
class leafComponent extends leafBaseObject
{
    ...
    private function initPaths()
    {
        ...
        /** @var \Leaf\Autoload\ClassLoader $autoloader */
        $autoloader = leaf_get_property( 'autoloader' );
        $classPath  = $autoloader->findFile( $className );
        $location   = $classPath;
    ...
    public function buildOutput( $template, $assigns = [] )
    {
